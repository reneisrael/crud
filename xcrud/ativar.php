...
<?php 
	...
	$sql = mysql_query("UPDATE usuarios SET ativado='1' WHERE usuarioID='{$usuario_id}' AND senha='{$senha}'");

	$sql_doublecheck = mysql_query("SELECT * FROM usuarios WHERE usuarioID='{$usuario_id}' AND senha='{$senha}' AND ativado='1'");
