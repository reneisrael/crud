<<<<<<< HEAD
<?php /** Configuration file; f0ska xCRUD v.1.6.5; 01/2014 */
class Xcrud_config
{
    // default connection
    public static $dbname = 'xcrud'; // Your database name
    public static $dbuser = 'root'; // Your database username
    public static $dbpass = 'rootroot'; // // Your database password
    ...
    public static $language = 'br'; // sets default localization
...
class Xcrud_config
{
    ...
    // alert settings
    public static $email_from = 'rafaela.vilela@gmail.com'; // email from address
    public static $email_from_name = '100incêndio'; // email from name
    public static $email_enable_html = true; // enables html in email letters
    ...
    public static $date_format = 'dd/mm/yy'; // 'yy/mm/dd' jqueryui date format
    public static $time_format = 'HH:mm:ss'; // 'HH:mm:ss' jqueryui time format
    public static $php_date_format = 'd/m/Y'; // 'Y/m/d' 2012/03/24->24/03/2012 php date format
    public static $php_time_format = 'H:i:s'; // 'H:i:s' 17:45:12 php time format   
